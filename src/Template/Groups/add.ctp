...
<section class="content-header">
    <div class="row">
        <div class="col-xs-12 col-md-6">
            <h4><?= __d('Groups', 'Create {0}', ['Group']) ?></h4>
        </div>
    </div>
</section>
        ...
        <div class="col-xs-12 col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-xs-<?= !empty($remoteGroups) ? 6 : 12 ?>">
                            <div><?= $this->Form->label(__d('Groups', 'Users')); ?></div>
                        ...
                        <?php if (!empty($remoteGroups)) : ?>
                            <div class="col-xs-6">
                                <div><?= $this->Form->label(__d('Groups', 'Remote Group')); ?></div>
                ...
                <div class="box-footer">
                    <?= $this->Form->button(__d('Groups', 'Submit'), ['class' => 'btn btn-primary']) ?>
                </div>
                <?= $this->Form->end() ?>
            </div>
        </div>
